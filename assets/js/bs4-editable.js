...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        renderList: function() {
            ...
            //this.options.typeahead.render = $.proxy(this.typeaheadRender, ta);
            ...
            //this.$input.on('typeahead:render',  this.typeaheadRender);
            //this.$element.on('typeahead:render',  function(e) { alert('element render'); });
        ...
        */
        typeaheadRender: function (e, items) {
            var that = this;
