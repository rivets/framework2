...
./vendor/vimeo/psalm/psalm --no-progress --stats --config=ipsalm.xml --find-unused-psalm-suppress --config=testing/psalm.xml --show-info=true --find-dead-code=true --taint-analysis
